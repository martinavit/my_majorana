...
void lett(string inputRootFile){
    ...
    Double_t num_dy1_ossf[npoint];
    Double_t den_dy1_ossf[npoint];
    Double_t num_dy2_ossf[npoint];
    Double_t den_dy2_ossf[npoint];
    ...
    Double_t dy1_ossf[npoint];
    Double_t dy2_ossf[npoint];
    ...
    Double_t num_dy1_n_ossf[npoint];
    Double_t den_dy1_n_ossf[npoint];
    Double_t num_dy2_n_ossf[npoint];
    Double_t den_dy2_n_ossf[npoint];
    ...
    Double_t dy1_n_ossf[npoint];
    Double_t dy2_n_ossf[npoint];
    ...
    ifstream wgn("txt_file/pt_10_30_kin/wg_ptcut_max.txt");
    if(!wgn){
    ...
    ifstream wzn("txt_file/pt_10_30_kin/wz_ptcut_max.txt");
    if(!wzn){
        cout<<"Il file non esiste "<<endl;
        return;
    }
    ...
    wzn.close();
    ifstream ttn("txt_file/pt_10_30_kin/tt_ptcut_max.txt");
    if(!ttn){
        cout<<"Il file non esiste "<<endl;
        return;
    }
    ...
    ttn.close();
    /*ifstream zgn("txt_file/pt_10_30_kin/zg_ptcut_max.txt");
     if(!zgn){
     cout<<"Il file non esiste "<<endl;
     return;
     }
     ...
     zgn.close();*/
    ifstream dy1n("txt_file/pt_10_30_kin/dy1_ptcut_max.txt");
    if(!dy1n){
        cout<<"Il file non esiste "<<endl;
        return;
    }
    int dy1 = 0;
    while((dy1n>>x_point[dy1]>>num_dy1_ossf[dy1] >>num_dy1_n_ossf[dy1]>>den_dy1_ossf[dy1] >>den_dy1_n_ossf[dy1])){
        dy1++;
    }
    dy1n.close();
    
    
    ifstream dy2n("txt_file/pt_10_30_kin/dy2_ptcut_max.txt");
    if(!dy2n){
        cout<<"Il file non esiste "<<endl;
        return;
    }
    int dy2 = 0;
    while((dy2n>>x_point[dy2]>>num_dy2_ossf[dy2] >>num_dy2_n_ossf[dy2]>>den_dy2_ossf[dy2] >>den_dy2_n_ossf[dy2])){
        dy2++;
    }
    dy2n.close();
    
    
    ifstream signal_50n("txt_file/pt_10_30_kin/signal_ptcut_50_max.txt");
    if(!signal_50n){
        cout<<"Il file non esiste "<<endl;
        return;
    }
    ...
    signal_50n.close();
    ifstream signal_20n("txt_file/pt_10_30_kin/signal_ptcut_20_max.txt");
    if(!signal_20n){
        cout<<"Il file non esiste "<<endl;
        return;
    }
    ...
    signal_20n.close();
    ifstream signal_10n("txt_file/pt_10_30_kin/signal_ptcut_10_max.txt");
    if(!signal_10n){
        cout<<"Il file non esiste "<<endl;
        return;
    }
    ...
    // =============== ROC curves =============
    for (int i =0; i< npoint; i++){
        back_den_ossf[i]=den_wg_ossf[i]+den_wz_ossf[i]+den_tt_ossf[i]+den_dy1_ossf[i] +den_dy2_ossf[i];
        back_sum_ossf[i]=TMath::Sqrt(num_wg_ossf[i]+num_wz_ossf[i]+num_tt_ossf[i]+num_dy1_ossf[i]+num_dy2_ossf[i]);
        back_den_n_ossf[i]=den_wg_n_ossf[i]+den_wz_n_ossf[i]+den_tt_n_ossf[i]+den_dy1_n_ossf[i] +den_dy2_n_ossf[i];
        back_sum_n_ossf[i]=TMath::Sqrt(num_wg_n_ossf[i]+num_wz_n_ossf[i]+num_tt_n_ossf[i]+num_dy1_n_ossf[i]+num_dy2_n_ossf[i]);
    ...
    for (int i =0; i< npoint; i++){
        if (back_sum_n_ossf[i] == 0 ) {
            num_signal_10_n_ossf[i]=0;
            num_signal_20_n_ossf[i]=0;
            num_signal_50_n_ossf[i]=0;
        }
        else{
            num_signal_10_n_ossf[i]= num_signal_10_n_ossf[i]/back_sum_n_ossf[i];
            num_signal_20_n_ossf[i]= num_signal_20_n_ossf[i] /back_sum_n_ossf[i];
            num_signal_50_n_ossf[i]= num_signal_50_n_ossf[i] /back_sum_n_ossf[i];
            
        }
        
        if (back_sum_ossf[i] == 0 ) {
            num_signal_10_ossf[i]=0;
            num_signal_20_ossf[i]=0;
            num_signal_50_ossf[i]=0;
        }
        else{
            num_signal_10_ossf[i]= num_signal_10_ossf[i] /back_sum_ossf[i];
            num_signal_20_ossf[i]= num_signal_20_ossf[i]/back_sum_ossf[i];
            num_signal_50_ossf[i]= num_signal_50_ossf[i]/ back_sum_ossf[i];
        }
    }
    ...
    g_pt_signal_50_ossf = new TGraphErrors(npoint, x_point, num_signal_50_ossf,  0, 0);
    g_pt_signal_20_ossf = new TGraphErrors(npoint, x_point, num_signal_20_ossf,  0, 0);
    g_pt_signal_10_ossf = new TGraphErrors(npoint, x_point, num_signal_10_ossf,  0, 0);
    ...
    g_pt_signal_50_n_ossf = new TGraphErrors(npoint, x_point, num_signal_50_n_ossf,  0, 0);
    g_pt_signal_20_n_ossf = new TGraphErrors(npoint, x_point, num_signal_20_n_ossf,  0, 0);
    g_pt_signal_10_n_ossf = new TGraphErrors(npoint, x_point, num_signal_10_n_ossf,  0, 0);
    ...
    cosmesi(1,*&g_pt_signal_50_ossf, "p_{T} (GeV)  ","S/#sqrt(B)" );
    cosmesi(2,*&g_pt_signal_20_ossf, "p_{T} (GeV)  ","S/#sqrt(B)" );
    cosmesi(3,*&g_pt_signal_10_ossf, "p_{T} (GeV)  ","S/#sqrt(B)" );
    ...
    cosmesi(1,*&g_pt_signal_50_n_ossf, "p_{T} (GeV)  ","S/#sqrt(B)" );
    cosmesi(2,*&g_pt_signal_20_n_ossf, "p_{T} (GeV)  ","S/#sqrt(B)" );
    cosmesi(3,*&g_pt_signal_10_n_ossf, "p_{T} (GeV)  ","S/#sqrt(B)" );
