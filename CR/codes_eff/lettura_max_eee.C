...
void lett(string inputRootFile){
    ...
    ifstream wgn("txt_file/wg_ptcut_eee_max.txt");
    if(!wgn){
    ...
    ifstream wzn("txt_file/wz_ptcut_eee_max.txt");
    if(!wzn){
        cout<<"Il file non esiste "<<endl;
        return;
    }
    ...
    wzn.close();
    ifstream ttn("txt_file/tt_ptcut_eee_max.txt");
    if(!ttn){
        cout<<"Il file non esiste "<<endl;
        return;
    }
    ...
    ttn.close();
    ifstream zgn("txt_file/zg_ptcut_eee_max.txt");
    if(!zgn){
        cout<<"Il file non esiste "<<endl;
        return;
    }
    ...
    zgn.close();
    ifstream signal_50n("txt_file/signal_ptcut_50_eee_max.txt");
    if(!signal_50n){
        cout<<"Il file non esiste "<<endl;
        return;
    }
    ...
    signal_50n.close();
    ifstream signal_20n("txt_file/signal_ptcut_20_eee_max.txt");
    if(!signal_20n){
        cout<<"Il file non esiste "<<endl;
        return;
    }
    ...
    signal_20n.close();
    ifstream signal_10n("txt_file/signal_ptcut_10_eee_max.txt");
    if(!signal_10n){
        cout<<"Il file non esiste "<<endl;
        return;
    }
    ...
    c_pt_eff->Print("PLOT_PT/c_pt_eff_eee_max.root");
    delete  c_pt_eff ;
    ...
    c_pt_eff_2d->Print("PLOT_PT/c_pt_eff_2d_eee_max.root");
    delete  c_pt_eff_2d ;    
